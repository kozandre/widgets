...
const HomePage = () => {
  ...
  const layout = [
    ...
    { i: '2', x: 0 , y: 1, w: 8, h: 3, resizeHandles: ['s', 'w', 'e', 'n', 'sw', 'nw', 'se', 'ne'] },
    { i: '3', x: 8, y: 0, w: 4, h: 3, resizeHandles: ['s', 'w', 'e', 'n', 'sw', 'nw', 'se', 'ne'] },
  ];
